 ...
 * @author q1
 */
public class ContextMenuMouse extends MouseAdapter {
    ...
    public ContextMenuMouse() {
        undoAction = new AbstractAction("Rückgangig machen") {
        ...
        selectAllAction = new AbstractAction("Alles auswählen") {
